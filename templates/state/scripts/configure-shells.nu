...
def write-nushell-environment [
  ...
  $lines = ($lines | append [
    $"$env.PNPM_HOME = (quote-shell ($managed_bin | into string) nu)"
...
def write-fish-adapter [
  ...
  mut lines = [
    ...
    $"set -gx PNPM_HOME (quote-shell ($managed_bin | into string) fish)"
...
def write-powershell-adapter [
  ...
  mut lines = [
    "# Generated by Reseed; changes are overwritten by the next restore."
    $"$env:PNPM_HOME = (quote-shell ($managed_bin | into string) powershell)"
...
def posix-adapter-lines [
  ...
  mut lines = [
    "# Generated by Reseed; changes are overwritten by the next restore."
    $"export PNPM_HOME=(quote-shell ($managed_bin | into string) posix)"
